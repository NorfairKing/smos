...
, genvalidity-sydtest, genvalidity-text, genvalidity-typed-uuid
, genvalidity-uuid, lib, mergeful, path, QuickCheck, semver
, smos-api, smos-data, smos-data-gen, smos-report, sydtest
, sydtest-aeson, sydtest-discover, text, time, typed-uuid, uuid
}:
mkDerivation {
  pname = "smos-api-gen";
  version = "0.3.2";
  ...
  testHaskellDepends = [
    ...
    mergeful path semver smos-api smos-data smos-report sydtest
    sydtest-aeson time typed-uuid uuid
  ];
