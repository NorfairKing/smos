...
mkDerivation {
  ...
  testHaskellDepends = [
    ...
    data-default deepseq genvalidity genvalidity-containers
    genvalidity-sydtest genvalidity-sydtest-aeson genvalidity-text
    genvalidity-time ical ical-gen ical-recurrence-gen path path-io
    QuickCheck safe smos-data smos-data-gen sydtest text time yaml
  ];
