...
, servant-auth-client, servant-client, shakespeare, smos
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    servant-client shakespeare smos smos-client smos-sync-client
    smos-web-style stm template-haskell text time typed-uuid unliftio
    wai-extra warp yesod yesod-auth yesod-autoreload yesod-static
    yesod-static-remote yesod-websockets
  ];
