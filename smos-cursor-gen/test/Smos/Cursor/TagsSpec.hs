...
spec = do
  ...
  describe "tagsCursorAppendTag" $
    it "produces valid tags cursors" $ producesValidsOnValids2 tagsCursorAppendTag
  describe "tagsCursorInsertAndSelectTag" $
    it "produces valid tags cursors" $ producesValidsOnValids2 tagsCursorInsertAndSelectTag
  describe "tagsCursorAppendAndSelectTag" $
    it "produces valid tags cursors" $ producesValidsOnValids2 tagsCursorAppendAndSelectTag
  describe "tagsCursorDelete" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorDelete
  describe "tagsCursorRemove" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorRemove
  ...
  describe "tagsCursorSelectOrCreatePrev" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorSelectOrCreatePrev
  describe "tagsCursorSelectOrCreateNext" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorSelectOrCreateNext
  ...
  describe "tagsCursorSelectPrevTag" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorSelectPrevTag
  describe "tagsCursorSelectNextTag" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorSelectNextTag
  describe "tagsCursorSelectOrCreatePrevTag" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorSelectOrCreatePrevTag
  describe "tagsCursorSelectOrCreateNextTag" $
    it "produces valid tags cursors" $ producesValidsOnValids tagsCursorSelectOrCreateNextTag
