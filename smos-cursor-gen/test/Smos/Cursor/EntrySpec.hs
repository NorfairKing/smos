...
spec = do
  ...
  describe "entryCursorSelectHeaderAtStart" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectHeaderAtStart
  describe "entryCursorSelectHeaderAtEnd" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectHeaderAtEnd
  describe "entryCursorSelectContents" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectContents
  describe "entryCursorSelectTimestamps" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectTimestamps
  describe "entryCursorSelectProperties" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectProperties
  describe "entryCursorSelectStateHistory" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectStateHistory
  ...
  describe "entryCursorSelectLogbook" $
    it "produces valid cursors" $ producesValidsOnValids entryCursorSelectLogbook
