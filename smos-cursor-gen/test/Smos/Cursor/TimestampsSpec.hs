...
spec = do
  ...
  describe "timestampsCursorDeleteChar" $
    it "produces valid cursors" $ producesValidsOnValids timestampsCursorDeleteChar
  describe "timestampsCursorSelectNextChar" $
    it "produces valid cursors" $ producesValidsOnValids timestampsCursorSelectNextChar
  describe "timestampsCursorSelectPrevChar" $
    it "produces valid cursors" $ producesValidsOnValids timestampsCursorSelectPrevChar
  describe "timestampsCursorInsertEmptyAndSelect" $
    it "produces valid cursors" $ producesValidsOnValids2 timestampsCursorInsertEmptyAndSelect
  describe "timestampsCursorInsertAndSelect" $
    it "produces valid cursors" $ producesValidsOnValids3 timestampsCursorInsertAndSelect
  describe "timestampsCursorAppendEmptyAndSelect" $
    it "produces valid cursors" $ producesValidsOnValids2 timestampsCursorAppendEmptyAndSelect
  describe "timestampsCursorAppendAndSelect" $
    it "produces valid cursors" $ producesValidsOnValids3 timestampsCursorAppendAndSelect
  describe "timestampsCursorSelectOrAdd" $
    it "produces valid cursors" $ producesValidsOnValids3 timestampsCursorSelectOrAdd
