...
, smos-api-gen, smos-server, smos-server-gen, smos-sync, sydtest
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    QuickCheck servant-client smos-api smos-api-gen smos-sync sydtest
  ...
  testHaskellDepends = [
    ...
    smos-server smos-server-gen smos-sync sydtest
    sydtest-persistent-sqlite sydtest-wai text
  ];
  testToolDepends = [ sydtest-discover ];
  benchmarkHaskellDepends = [
    base criterion genvalidity-criterion smos-sync
  ];
