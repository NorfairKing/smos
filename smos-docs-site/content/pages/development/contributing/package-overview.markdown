...
description: An overview of the different Smos packages
---
...
smos-cli                 ; Library for command-line responsibilities
smos-directory           ; Library for reading from Smos directories
...
smos-github              : The smos-github tool: to integrate with GitHub efficiently.
smos-scheduler           : The smos-scheduler tool: to automate setting up recurring projects.
smos-calendar-import     : The smos-calendar-import tool: to import calendars in an ongoing manner
smos-jobhunt             : The smos-jobhunt tool: to help with application processes
