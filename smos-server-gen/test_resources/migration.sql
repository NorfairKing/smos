...
CREATE TABLE "booking_config"("id" INTEGER PRIMARY KEY,"user" INTEGER NOT NULL REFERENCES "user" ON DELETE RESTRICT ON UPDATE RESTRICT,"name" VARCHAR NOT NULL,"email_address" VARCHAR NOT NULL,"time_zone" VARCHAR NOT NULL,CONSTRAINT "unique_booking_config_user" UNIQUE ("user"));
