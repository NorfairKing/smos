...
, genvalidity-typed-uuid, http-client, http-client-tls, http-types
, ical, lib, mergeful, mtl, path, path-io, persistent
, persistent-sqlite, QuickCheck, safe, semver, servant
