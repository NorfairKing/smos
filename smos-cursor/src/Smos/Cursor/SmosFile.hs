...
module Smos.Cursor.SmosFile
  ( SmosFileCursor (..),
    ...
    smosFileCursorToggleHideEntryLens,
...
smosFileCursorToggleHideEntryLens :: Lens' (CollapseEntry EntryCursor) Bool -> SmosFileCursor -> SmosFileCursor
smosFileCursorToggleHideEntryLens field =
